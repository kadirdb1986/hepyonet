      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-surface-container-lowest rounded-2xl shadow-[0_20px_40px_rgba(25,28,30,0.06)] p-8 flex flex-col gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={copyUrl}
              className="bg-primary text-on-primary px-4 py-3 rounded-xl font-bold flex items-center gap-2 hover:translate-y-[-1px] active:scale-95 transition-all text-sm whitespace-nowrap"
            >
